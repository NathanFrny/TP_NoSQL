    ...
    $cols = [
        '_id' => ['lbl' => '#', 'type' => 'id'],
        'title' => ['lbl' => 'Titre', 'type' => 'text'],
        'year' => ['lbl' => 'Année', 'type' => 'text'],
        'production' => ['lbl' => 'Production', 'type' => 'array'],
        'actors' => ['lbl' => 'Acteurs', 'type' => 'array'],
        'synopsis' => ['lbl' => 'Synopsis', 'type' => 'textarea'],
        'id_tmdb' => ['lbl' => 'TMDB', 'type' => 'text'],
    ];
    ...
    foreach ($cols as $key => $value) {
        ...
        if ($key !== '_id' && GETPOST($searchKey)) {  
            $arr_search[$key] = ['$regex' => GETPOST($searchKey), '$options' => 'i']; 
        }
    }
